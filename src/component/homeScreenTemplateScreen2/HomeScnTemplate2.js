...
import {Template2Skeleton} from '../skelton/SkeltonComponent';

const HomeScnTemplate2 = () => {
  ...
  const renderItem = ({item, index}) => {
    return (
      <LinearGradient key={index} colors={['#6A96FF', '#9558FF']}>
        <View
...
export default HomeScnTemplate2;
